...
export const HabitItemSelectObjectSchema: SchemaType = z.object({
    id: z.boolean().optional(), createdAt: z.boolean().optional(), updatedAt: z.boolean().optional(), isDeleted: z.boolean().optional(), name: z.boolean().optional(), sort: z.boolean().optional(), enabled: z.boolean().optional(), count: z.boolean().optional(), frequency: z.boolean().optional(), groupId: z.boolean().optional(), group: z.union([z.boolean(),
